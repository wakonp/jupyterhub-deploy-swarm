...
def create_dir_hook(spawner):
    ...
    spawner.environment['NB_UID']=os.system('docker exec jupyterhub_nfs id -u ' +username.lower())
    spawner.environment['NB_GID']=os.system('docker exec jupyterhub_nfs id -g ' +username.lower())
